...
export const buttonVariants = tv({
	...
	variants: {
		...
		size: {
			...
			xsmall: {
				root: "h-8 gap-2.5 rounded-lg px-2.5 label-sm",
				icon: "-mx-1",
			},
			xxsmall: {
				root: "h-7 gap-2.5 rounded-lg px-2 label-xs",
				icon: "-mx-1",
			},
		},
	},
	compoundVariants: [
		...
		},
		{
			...
			class: {
				root: [
					// base
					"bg-primary-base/10 text-primary-base ring-transparent hover:bg-primary-base/20",
				],
			},
		},
		//#endregion
		...
		},
		{
			...
			class: {
				root: [
					// base
					"bg-bg-weak-50 text-text-sub-600 ring-transparent hover:bg-bg-white-0 hover:text-text-strong-950 hover:shadow-regular-xs hover:ring-stroke-soft-200",
				],
			},
		},
		//#endregion
		...
		},
		{
			...
			class: {
				root: [
					// base
					"bg-red-alpha-10 text-error-base ring-transparent hover:bg-bg-white-0 hover:ring-error-base",
				],
			},
		},
		{
		...
		},
		{
			...
			class: {
				root: [
					// base
					"bg-red-alpha-10 text-success-base ring-transparent",
					// hover
		...
		},
		{
			...
			class: {
				root: [
					// base
					"bg-success-lighter text-success-base hover:bg-success-light",
				],
			},
		},
		//#endregion
		...
		//#region variant=information
		{
			...
			class: {
				root: [
					...
					// focus
					"focus-visible:shadow-button-information-focus",
				],
			},
		},
		{
			...
			class: {
				root: [
					// base
					"bg-bg-white-0 text-information-base ring-information-base",
					// hover
					"hover:bg-information-alpha-10 hover:ring-transparent",
					// focus
					"focus-visible:shadow-button-information-focus",
				],
			},
		},
		{
			...
			class: {
				root: [
					// base
					"bg-information-alpha-10 text-information-base ring-transparent",
					// hover
					"hover:bg-bg-white-0 hover:ring-information-base",
					// focus
					"focus-visible:bg-bg-white-0 focus-visible:shadow-button-information-focus focus-visible:ring-information-base",
				],
			},
		},
		{
			...
			class: {
				root: [
					// base
					"bg-transparent text-information-base ring-transparent",
					// hover
					"hover:bg-information-alpha-10",
					// focus
					"focus-visible:bg-bg-white-0 focus-visible:shadow-button-information-focus focus-visible:ring-information-base",
				],
			},
		},
		{
			...
			class: {
				root: [
					// base
					"bg-information-lighter text-information-base ring-transparent hover:bg-information-light",
				],
			},
		},
		//#endregion
...
export { ButtonIcon, ButtonRoot as Button };
